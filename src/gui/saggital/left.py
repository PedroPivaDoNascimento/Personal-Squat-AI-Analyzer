...
def show_sagittal_left_analysis(): 
    ...
    if uploaded_file_data and name_input and user_height_cm:
        set_folders = SetFolders(person_name=name_input, plane_folder_name="sagital", side="esquerdo")
...
def process_and_analyze_video(uploaded_file, name_input, user_height_cm, params):
    ...
    excel_writer = SagittalReportExcelWriter(name_input, ai.squat_analyzer, "esquerdo")
